export const PaletteVizualizations = () => {
    return (
        <section className="min-h-[90vh] flex flex-col max-w-[1280px] mx-auto w-full mt-32">
            <header className="p-4 flex justify-between">
                <div className="px-2 gap-4 flex items-center cursor-pointer">
                    <div>
                        <svg width="32" height="32" viewBox="0 0 175 175" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="175" height="45" fill="#82181a "/>
                            <rect x="175" width="175" height="45" transform="rotate(90 175 0)" fill="#82181a "/>
                            <circle cx="65" cy="110" r="65" fill="oklch(50.5% 0.213 27.518)"/>
                        </svg>
                    </div>
                    <div className="text-xl"><span className="font-bold">Example</span>Logo</div>
                </div>
                <div className="px-2 flex gap-4 items-center">
                    ...
                    <button className="px-4 py-2 cursor-pointer border-4 border-red-900 bg-red-900 text-white font-bold">Action!</button>
                </div>
            </header>
            <main className="grid flex-1 grid-cols-2 items-center">
                <div className="px-16">
                    <div className="text-5xl font-bold tracking-tighter">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. <span className="text-red-900">Cras euismod dua et vehicula.</span>
                    </div>
