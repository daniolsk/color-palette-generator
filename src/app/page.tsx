	...
	return (
		<div className='flex flex-col min-h-screen'>
			...
			<Tooltip
				...
				opacity={1}
			>
				Kolory w przestrzeni barw CMYK mogą odbiegać od ich odpowiedników w
				innych formatach.
			</Tooltip>
			<div
				className={`${
			...
			>
				...
				>
					<Dice5 className='hover:-translate-y-1 transition-all active:scale-105 cursor-pointer' />
				</div>
				<div
					className='p-4 bg-white rounded-2xl shadow-lg'
					onClick={() =>
			...
			>
				<div className='max-w-[1280px] mx-auto flex justify-between items-center'>
					<Link
						href='/'
						className='text-xl desktop:text-2xl font-medium tracking-tighter'
					>
			...
			<div
				className='justify-center flex text-lg gap-4 items-center cursor-pointer'
				onClick={() =>
					document.getElementById('landingPageVisualization')!.scrollIntoView({
						behavior: 'smooth',
						block: 'center',
					})
				}
			...
			<div
				className='max-w-[1280px] px-4 mx-auto w-full mb-8 mt-32 flex flex-col gap-2'
			...
			>
				...
				<div className='bg-white py-6 px-8 rounded-2xl flex flex-col'>
					<div className='flex gap-4 justify-around'>
						<div className='flex flex-col gap-4 w-full'>
							<div className='flex flex-col gap-2'>
								<div className='text-sm'>Kolor główny</div>
								<div
									className={`shadow-lg h-24 aspect-video px-4 py-2 rounded-2xl w-full flex justify-center items-center`}
									style={{
										backgroundColor: palette[0],
										color: Color(palette[0]).isLight()
											? 'rgba(0,0,0,1)'
											: 'rgba(255,255,255,1)',
									}}
								>
